 ...
 * Des:
 */
class CheckGooglePlayServiceKit(override val icon: Int = R.mipmap.ic_launcher, override val name: Int = R.string.kit_check_google_play_service_switch) : AbstractKit() {
